...
![Sections](images/highlight-sections.png) _The **Section menu** is the horizontal menu located on the top of the backoffice._
...
![Tree](images/highlight-tree.png) _The content tree_
...
![Dashboard](images/highlight-dashboard.png) _Default dashboard in the content section_
...
## [Content Templates](broken-reference)
